...
Kept so legacy `from api.domain.services.llm import llm, model_for_role, LLMClient` imports work.
"""
...
from api.infrastructure.dependencies import LazyLLMProxy, get_llm, model_for_role
