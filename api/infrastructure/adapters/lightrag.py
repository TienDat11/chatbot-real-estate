...
from api.infrastructure.ports.rag import RagChunk, RagPort, RagResult
from api.application.services.rag_leg import _get_rag, _make_query_param, _normalize_chunks
...
class LightRag(RagPort):
    ...
    async def retrieve(
        ...
        try:
            rag = await asyncio.wait_for(_get_rag(), timeout=15.0)
