...
from api.infrastructure.ports.sql import SqlPort, SqlResult
from api.application.services.sql_leg import run_sql_leg
...
class PostgresSql(SqlPort):
    ...
    async def rows_from_nl2sql(self, query: str, as_of: date | None) -> SqlResult:
        ...
        from api.domain.services.nl2sql_guard import run_nl2sql  # noqa: PLC0415 — lazy to avoid import cycle
